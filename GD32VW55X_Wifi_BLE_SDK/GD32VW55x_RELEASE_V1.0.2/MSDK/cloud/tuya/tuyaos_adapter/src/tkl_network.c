...
OPERATE_RET tkl_net_set_bufsize(CONST INT_T fd, CONST INT_T buf_size, CONST TUYA_TRANS_TYPE_E type)
{
    ...
    if (setsockopt(fd, SOL_SOCKET, optname, (const char *)&size, sizeof(INT_T)) < 0) {
...
OPERATE_RET tkl_net_set_reuse(CONST INT_T fd)
{
    ...
    if (0 != setsockopt(fd, SOL_SOCKET, SO_REUSEADDR, (const char *)&reuse, sizeof(INT_T))) {
...
OPERATE_RET tkl_net_disable_nagle(CONST INT_T fd)
{
    ...
    if (0 != setsockopt(fd, IPPROTO_TCP, TCP_NODELAY, (const char *)&nodelay, sizeof(INT_T))) {
...
OPERATE_RET tkl_net_set_broadcast(CONST INT_T fd)
{
    ...
    if (0 != setsockopt(fd, SOL_SOCKET, SO_BROADCAST, (const char *)&opt, sizeof(INT_T))) {
        return OPRT_COM_ERROR;
    }
